...
-   
    ...
    The *instance *argument must be a funcallable instance (it must have been returned by****[allocate-instance (class funcallable-standard-class)](/meta-object-protocol/dictionary/allocate-instance-funcallable-standard-class).**
