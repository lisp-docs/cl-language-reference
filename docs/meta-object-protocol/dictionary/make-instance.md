...
**Methods:**
  ...
  --------------------------------------------------------------------------------------------------------------------------
  [**make-instance** (*class* symbol) `&rest` *initargs*](/meta-object-protocol/dictionary/make-instance-symbol)
  [**make-instance** (*class* standard-class) `&rest` *initargs*](/meta-object-protocol/dictionary/make-instance-standard-class)
  [**make-instance** (*class* funcallable-standard-class) `&rest` *initargs*](/meta-object-protocol/dictionary/make-instance-funcallable-standard-class)
  --------------------------------------------------------------------------------------------------------------------------
