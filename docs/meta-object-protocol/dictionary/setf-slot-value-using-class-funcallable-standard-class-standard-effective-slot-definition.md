setf-slot-value-using-class-funcallable-standard-class-standard-effective-slot-definition
=========================================================================================
...
This is a method on the generic function[(setf slot-value-using-class)](/meta-object-protocol/dictionary/setf-slot-value-using-class).
