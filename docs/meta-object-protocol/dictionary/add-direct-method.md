...
This set can be accessed as a list by calling the generic function[specializer-direct-methods](/meta-object-protocol/dictionary/specializer-direct-methods). Methods are removed from the set by [remove-direct-method](/meta-object-protocol/dictionary/remove-direct-method).

The generic function **add-direct-method** is called by [add-method](/meta-object-protocol/dictionary/add-method) whenever a method is added to a generic function. It is called once for each of the specializers of the method. Note that in cases where a specializer appears more than once in the specializers of a method, this generic function will be called more than once with the same specializer as argument.
...
**Methods:**
  ...
  -----------------------------------------------------------------------------------------------------------------
  [**add-direct-method** (*specializer* class) (*method* method)](/meta-object-protocol/dictionary/add-direct-method-class)
  [**add-direct-method** (*specializer* eql-specializer) (*method* method)](/meta-object-protocol/dictionary/add-direct-method-eql-specializer)
  -----------------------------------------------------------------------------------------------------------------
