...
When a class is finalized,[finalize-inheritance](/meta-object-protocol/dictionary/finalize-inheritance) calls this generic function and associates the returned value with the class metaobject. The value can then be accessed by calling [class-precedence-list](/meta-object-protocol/dictionary/class-precedence-list).

**Methods:**

  ---------------------------------------------------------------------------------------------
  [**compute-class-precedence-list** (*class* class)](/meta-object-protocol/dictionary/compute-class-precedence-list-class)
  ---------------------------------------------------------------------------------------------
