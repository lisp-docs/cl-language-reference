...
When a class is finalized,[finalize-inheritance](/meta-object-protocol/dictionary/finalize-inheritance) calls this generic function and associates the returned value with the class metaobject. The value can then be accessed by calling [class-default-initargs](/meta-object-protocol/dictionary/class-default-initargs).
...
**Methods:**
  ...
  -----------------------------------------------------------------------------------------------------------------------------
  [**compute-default-initargs** (*class* standard-class)](/meta-object-protocol/dictionary/compute-default-initargs-standard-class)
  [**compute-default-initargs** (*class* funcallable-standard-class)](/meta-object-protocol/dictionary/compute-default-initargs-funcallable-standard-class)
  -----------------------------------------------------------------------------------------------------------------------------
