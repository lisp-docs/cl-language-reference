...
This is a method on the generic function[add-direct-method](/meta-object-protocol/dictionary/add-direct-method).
...
This method cannot be overridden unless the following methods are overridden as well:
  ...
  ----------------------------------------------------------------------------------------------------------
  [**remove-direct-method**(*class* class) (*method* method)](/meta-object-protocol/dictionary/remove-direct-method-class)
