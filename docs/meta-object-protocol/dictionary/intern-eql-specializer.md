...
The result of calling[eql-specializer-object](/meta-object-protocol/dictionary/eql-specializer-object) on the result of a call to `intern-eql-special-izer} is only     guaranteed to be eql` to the original *object* argument, not necessarily `eq`.
