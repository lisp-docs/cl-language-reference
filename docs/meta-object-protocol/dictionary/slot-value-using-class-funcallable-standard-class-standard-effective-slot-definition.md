slot-value-using-class-funcallable-standard-class-standard-effective-slot-definition
====================================================================================
...
This is a method on the generic function[slot-value-using-class](/meta-object-protocol/dictionary/slot-value-using-class).
