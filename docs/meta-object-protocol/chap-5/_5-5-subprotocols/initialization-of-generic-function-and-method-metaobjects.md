...
An example of creating a generic function and a method metaobject, and then adding the method to the generic function is shown below. This example is comparable to the method definition shown in [this figure](/meta-object-protocol/dictionary/fig-defmethod-1).
