...
For each kind of program element there is a corresponding *basic metaobject class*. These are the classes: [class](/meta-object-protocol/dictionary/class-class), [slot-definition](/meta-object-protocol/dictionary/class-slot-definition), [generic-function](/meta-object-protocol/dictionary/class-generic-function), [method](/meta-object-protocol/dictionary/class-method), and [method-combination](/meta-object-protocol/dictionary/class-method-combination). A *metaobject class* is a subclass of exactly one of these classes. The results are undefined if an attempt is made to define a class that is a subclass of more than one basic metaobject class. A *metaobject* is an instance of a metaobject class.
