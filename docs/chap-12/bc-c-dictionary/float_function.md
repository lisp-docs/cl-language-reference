...
```lisp
(float 1 1.0)     ; → 1.0 (single-float)
(float 1 1.0d0)   ; → 1.0d0 (double-float)
...
```lisp
(float pi 1.0)   ; → 3.1415927 (single-float approximation of pi)
(float pi 1.0d0) ; → 3.141592653589793d0 (double-float approximation)
```
