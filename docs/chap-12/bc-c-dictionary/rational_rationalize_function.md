...
(rational 0.1)    ; → 13421773/134217728 (exact float value)
(rationalize 0.1) ; → 1/10 (simplest approximation)
...
```lisp
(float (rational 3.14) 1.0)    ; → 3.14
(float (rationalize 3.14) 1.0) ; → 3.14
```
