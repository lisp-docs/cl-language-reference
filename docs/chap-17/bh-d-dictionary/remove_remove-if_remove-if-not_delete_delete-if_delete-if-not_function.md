...
=> (1 3 5)
(remove-if #'upper-case-p "Hello World")
=> "ello orld"
```
...
```lisp
(remove 4 '(1 4 2 4 3 4 5) :count 2)
=> (1 2 3 4 5)
(remove 4 '(1 4 2 4 3 4 5) :count 1 :from-end t)
=> (1 4 2 4 3 5)
```
...
```lisp
(remove-if-not #'alpha-char-p "h3ll0 w0rld")
=> "hllwrld"
