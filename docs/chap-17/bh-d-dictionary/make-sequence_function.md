...
```lisp
(make-sequence 'list 5 :initial-element 0) ; → (0 0 0 0 0)
...
```lisp
(make-sequence 'vector 4 :initial-element nil) ; → #(NIL NIL NIL NIL)
(make-sequence '(vector integer) 3 :initial-element 42) ; → #(42 42 42)
```
